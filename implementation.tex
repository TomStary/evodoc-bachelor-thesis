...
Asi nejdůležitější částí je generování samotných dokumentů. Jak již bylo\linebreak v~textu této práce zmíněno, bude využit software Pandoc \cite{pandocSW}, abychom mohli s tímto softwarem

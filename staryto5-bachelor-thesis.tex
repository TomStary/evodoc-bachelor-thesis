...
\abstractCS{Práce se bude zabývat vytvářením modulárních dokumentů s důrazem na jejich verzování. Jedná se o webovou aplikaci, která má oddělené grafické a datové prostředí.}
\abstractEN{Sem doplňte ekvivalent abstraktu Vaší práce v~angličtině.}
\placeForDeclarationOfAuthenticity{V~Praze}
\declarationOfAuthenticityOption{4} %volba Prohlášení (číslo 1-6)
\keywordsCS{dokumenty, modulární, reStructured Text, AsciiDoc, python, ruby}
...
\todo{Dopsat pro jaké řešení jsem se rozhodl}
\todo{chapter: mozne vylepseni}
